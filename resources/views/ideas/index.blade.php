...
@section('content_header')
    <h1 class="bg-orange text-white text-center">IDEAS</h1>
@stop

@section('content')
<div class="container-fluid">
      <a type="button" href="{{ route('ideas.create') }}" class="bg-info px-12 py-2 rounded text-gray-200 font-semibold hover:bg-indigo-1000 transition duration-200 each-in-out">Crear idea</a>
      <br><br>
        ...
        <div class="col">
                ...
                <div class="card border h-100">
                    ...
                    <div class="card-footer d-flex justify-content-around">
                        ...
                        <span><a type="button" href="#" class="btn btn-success text-uppercase">Abrir Documento</a></span>

                        <!-- Botón editar -->
                        <span><a type="button" href="{{ route('ideas.edit', $idea->id) }}" class="btn btn-primary text-uppercase">Editar</a></span>
