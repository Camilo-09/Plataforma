...
class ChallengeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validate = $this->validate($request, [
            ...
            "nempresa" => ["required", "string", "max:255"],
            "nempresario" => ["required", "string", "max:255"],
        ]);
        ...
        $nempresa = $request->input("nempresa");
        $nempresario = $request->input("nempresario");
        ...
        $challenge->ubicacion = $ubicacion;
        $challenge->nempresa = $nempresa;
        $challenge->nempresario = $nempresario;
    ...
    public function update(Request $request, $id)
    {
        ...
        $challenge ->ubicacion= $request->input("ubicacion");
        $challenge -> nempresa=$request->input("nempresa");
        $challenge -> nempresario =$request->input("nempresario");
